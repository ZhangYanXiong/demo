						...
						<tr class="text-danger">
							<th>
								<div class="text-center row">
									<div class="col-md-4 col-xs-1 col-sm-3">序号</div>
									<div class="col-md-4 col-xs-1 col-sm-3">状态</div>
									<div class="col-md-4 col-xs-1 col-sm-3">操作</div>
								</div>
							</th>
							<th>
								<div class="text-center row">
							...
							<th>
								<div class="text-center row">
									<!-- <div class="text-center col-xs-3">
										<div class="text-center row">座位号</div>
									</div>
									<div class="text-center col-xs-3">
										<div class="text-center row ">状态</div>
									</div>
									<div class="text-center col-xs-3">
										<div class="text-center row ">操作</div>
									</div> -->
									<div class="col-md-4 col-xs-1 col-lg-8">序号</div>
									<div class="col-md-4 col-xs-1">状态</div>
									<div class="col-md-4 col-xs-1">操作</div>
								</div>
							</th>
							...
							<th class="text-danger">
								<div class="text-center row">
									...
									<div class="text-center col-md-4 col-xs-4">
										<button class="btn btn-success btn-xs btnv"><?php echo $arri[0]; ?></button>
									</div>
									<div class="text-center col-md-4 col-xs-4">		
						...
						<tr class="text-danger">
							<th class="text-danger">
								<div class="text-center row">
									...
									<div class="text-center col-md-4 col-xs-4">
										<div class="text-center row "><button class="btn btn-success btn-xs" id="btnv"><?php echo $arri[5]; ?></button></div>
									</div>
									<div class="text-center col-md-4 col-xs-4">
										<div class="text-center row ">
											<button class="btn btn-primary btn-xs" data-toggle="modal" data-target="#layer" v-on:click="nowIndex=index">预约</button>
